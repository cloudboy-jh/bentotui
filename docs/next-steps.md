...
- Named layout catalog shipped at `registry/layouts/` (Frame-first grammar + shared sizing engine)
- Starter and shipped bentos now use minimal top/subheader rows (tester banners removed)
